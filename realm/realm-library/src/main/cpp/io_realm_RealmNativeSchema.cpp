...
#include <jni.h>
#include "io_realm_RealmNativeSchema.h"
...
JNIEXPORT jlong JNICALL Java_io_realm_RealmNativeSchema_nativeCreateFromList(JNIEnv* env, jclass,
...
JNIEXPORT void JNICALL Java_io_realm_RealmNativeSchema_nativeClose(JNIEnv*, jclass, jlong nativePtr)
{
...
JNIEXPORT jlongArray JNICALL Java_io_realm_RealmNativeSchema_nativeGetAll(JNIEnv* env, jclass, jlong nativePtr)
{
    TR_ENTER_PTR(nativePtr)
    try {
        Schema* schema = reinterpret_cast<Schema*>(nativePtr);
